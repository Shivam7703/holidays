...
const milestones = [
  {
    ...
    title: "The Beginning",
    text:
      "Founded with a single office and a vision to simplify immigration for aspiring global citizens. Started with 3 team members and a passion for changing lives.",
  },
  {
    year: "2008",
    side: "right",
    ...
    text:
      "Expanded operations across 5 major cities, building a strong team of certified immigration consultants. Crossed 500 successful visa applications milestone.",
  },
  {
    year: "2012",
    side: "left",
    ...
    text:
      "Received our first international certification and established partnerships with 50+ universities worldwide, opening doors to global education pathways.",
  },
  {
    year: "2016",
    side: "right",
    ...
    text:
      "Celebrated helping 5,000+ clients achieve their immigration dreams. Launched our dedicated MBBS abroad and study visa divisions with specialized expert teams.",
  },
  {
    year: "2020",
    side: "left",
    ...
    text:
      "Launched our digital platform enabling end-to-end visa tracking and online consultation. Served clients across 100+ countries despite global challenges.",
  },
  {
    year: "2026",
    side: "right",
    ...
    text:
      "Celebrating two decades of trust — 10,000+ satisfied clients, 150+ country coverage, and a 95% approval rate. Growing stronger every year.",
  },
];
...
export default function OurHistory() {
  ...
  useEffect(() => {
    function updateLine() {
      ...
      const pct = Math.min(
        100,
        Math.max(0, ((wh - rect.top) / (rect.bottom - rect.top)) * 90)
      );
      setFillPct(pct);
    }
    ...
    <section className="relative overflow-hidden bg-color3 lg:px-20 md:px-14 sm:px-10 px-6 py-20">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="font-black text-white text-3xl md:text-5xl leading-tight mb-4 mt-3">
            The Story of Our History
          </h2>
          <p className="text-white/50 text-sm max-w-xl mx-auto leading-relaxed mb-5">
            From humble beginnings to a globally trusted immigration partner —
            two decades of excellence, dedication, and transforming lives.
          </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-20">
          {stats.map((s, i) => (
            ...
            >
              ...
              <p className="text-xs font-semibold text-color5 uppercase tracking-[0.1em]">
                {s.label}
              </p>
            </div>
          ))}
            ...
            {milestones.map((m, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div
                      className="group bg-white rounded-2xl relative overflow-hidden
                  ...
                  <div className="absolute left-0 top-5 md:hidden">
                    <div className="relative w-9 h-9">
                      ...
                      />
                      <div
                        className={`relative w-9 h-9 rounded-full flex items-center justify-center text-sm border-2 border-color3 shadow-md ${
                          isBlue ? "bg-color2" : "bg-color1"
                        }`}
                      >
                        {m.icon}
