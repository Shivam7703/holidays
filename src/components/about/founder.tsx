      ...
      >
        ...
        >
          ...
          <Image
            src={ceo}
            alt="Why choose us"
            className="object-contain object-bottom -mt-2 !h-full  mx-auto relative z-10 "
          />
        ...
        >
          ...
          <div className="border-l-[3px] border-color2 bg-white pl-5 py-2.5 shadow-lg rounded-r-2xl">
            ...
            <p className="text-color1 text-lg sm:text-xl font-black text-right mr-5 font1 tracking-widest !mt-3">
              — Zahoor Sofi, <span className="text-color2 font-medium block text-xs">Founder & CEO</span>
            </p>
          </div>
        </motion.div>
      </motion.div>
